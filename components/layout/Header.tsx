      ...
      <div className="px-4 sm:px-6">
        <div className="flex items-center justify-between h-16 gap-4">
          <div className="flex items-center gap-2 flex-shrink-0">
            <button onClick={onMenuClick} className="p-2 text-gray-500 hover:text-amber-500 transition-colors rounded-lg hover:bg-gray-100" aria-label="Toggle sidebar">
              <Menu size={22} />
            </button>
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <div className="hidden md:block">
              <div className="relative">
                ...
                <input type="text" placeholder="Search tools..." className="pl-9 pr-4 py-1.5 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-construction-amber focus:border-transparent w-48" />
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div className="py-1 px-2">
                  {user && <p className="text-xs text-gray-500 px-2 py-1 truncate">{user.email}</p>}
                  <button onClick={signOut} className="block w-full text-left px-2 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded">Sign Out</button>
                </div>
              </div>
            </div>
          </div>
